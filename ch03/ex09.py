...
>>>>>>> 85126b0983c1f49ef99889e00d704fd288f806a6
...
<<<<<<< HEAD
    ...
    pix = np.array(img.size)
    return pix

=======
    img = Image.open(image_file, mode='r')  # 이미지 파일 열기
...
<<<<<<< HEAD
    print(image_to_pixel('KIM.png'))
=======
    pixels_1 = image_to_pixel('kim.jpg')
    pixels_2 = image_to_pixel('kakao.png')
>>>>>>> 85126b0983c1f49ef99889e00d704fd288f806a6
